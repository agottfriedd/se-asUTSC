...
import { colors, signAccent } from '../theme';
  ...
  return (
    <div style={{ height: '100vh', overflowY: 'auto', background: 'var(--bg)' }}>
      ...
      <nav style={{
        ...
        background: 'var(--bg2-blur)', backdropFilter: 'blur(14px)', zIndex: 10,
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          <div style={{
            ...
            fontSize: 17, color: 'var(--on-pri)', fontWeight: 900,
          }}>S</div>
          <div>
      ...
      <div style={{
        ...
        margin: '0 0 52px', background: 'var(--bg3)',
      }}>
        {STATS.map(([n, l], i) => (
          <div key={i} style={{
          ...
          {SIGNS_ALPHA.map(s => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${hovered === s.id ? signAccent(s.color) : 'var(--bdr)'}`,
                background: hovered === s.id ? `${signAccent(s.color)}18` : 'var(--card)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: 17, fontWeight: 800, color: signAccent(s.color),
                transition: '.18s',
      ...
      <div style={{
        ...
        background: 'linear-gradient(180deg,transparent,var(--pri-soft))',
      }}>
